...
<div class="container">
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            <form method="POST" action="proses.php?aksi=add-benefit" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group mb-2">
                            <div class="form-group mb-3">
                                ...
                                <br>
                                <input type="file" name="benefit_image" required="" />
                            </div>
                            <div class="form-group mb-3">
                                <label>Nomor Heading</label>
                                <textarea class="form-control" id="editor2" name="benefit_heading" rows="5"></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label>Nomor Text</label>
                                <textarea class="form-control" id="editor2" name="benefit_text" rows="5"></textarea>
                            </div>
