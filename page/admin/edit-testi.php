          ...
          <div class="col-xl-6 text-center">
            <div class="card mb-4">
              <div class="form-group mb-2">
                ...
                <textarea class="form-control" id="editor2" name="testi_name" rows="5"><?php echo $data['testi_name']; ?></textarea>
              </div>
            </div>
          </div>
          <div class="col-xl-6 text-center">
            <div class="card mb-4">
              <div class="form-group mb-2">
                ...
                <textarea class="form-control" id="editor2" name="testi_profession" rows="5"><?php echo $data['testi_profession']; ?></textarea>
              </div>
            </div>
          </div>
          <div class="col-xl-6 text-center">
