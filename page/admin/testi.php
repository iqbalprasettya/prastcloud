...
<div class="mb-4">
    <a href="admin.php?page=add-testi" class="btn btn-success">Add</a>
</div>
        ...
        <div class="col-xl-4">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="aksi">
                        <a href="admin.php?page=edit-testi&id=<?php echo $row['id']; ?>" class="btn btn-success">Edit</a>
                        <a href="proses.php?aksi=delete-testi&id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                    </div>
                </div>
